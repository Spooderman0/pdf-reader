    ...
    <div className="flex flex-col min-h-screen bg-gray-100">
      ...
      <div className="container mx-auto p-6">
        ...
        <div className="flex justify-center gap-4 mt-4">
          {/* Navigation buttons */}
          <Link to="/pdf-analysis-indice" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
            ÍNDICE
          </Link>
          {/* ...other buttons */}
        </div>
...
export default PDFAnalysisFiguras;
